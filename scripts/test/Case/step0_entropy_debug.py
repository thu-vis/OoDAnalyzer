...
class step0EntropyDebug(DataAnimals):
    def __init__(self, dataname=None, suffix="", class_num=5):
        dataname = config.animals
        super(step0EntropyDebug, self).__init__(dataname, suffix)

    def entropy_analysis(self):
        ent = pickle_load_data(os.path.join(self.data_dir,
                                    "all_entropystep0_4_feature_8.pkl"))
        ...
        processed_data = pickle_load_data(os.path.join(self.data_dir, "processed_data.pkl"))
    ...
    def entropy_remove_others(self):
        ...
        pickle_save_data(os.path.join(self.data_dir,"processed_data_pred_remove_cage_and_others.pkl"), processed_data)
