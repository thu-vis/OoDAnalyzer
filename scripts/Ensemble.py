...
class Ensemble(object):
    ...
    def get_entropy(self):
        ...
        #                                             self.dataname,
        #                                             "all_entropy.pkl"))
        all_entropy = self.data.entropy
        self.all_entropy = all_entropy
        max_ent = scipy.stats.entropy([1 for _ in self.data.mat[config.class_name]])
        # all_entropy = (all_entropy / max_ent) ** 3
    ...
    def get_similar(self, id, k):
        all_idx = self.data.train_idx + self.data.test_idx
...
if __name__ == '__main__':
    ...
    # e.uncertainty(["svm", "logistic", "xgboost", "rf"])
    # e.entropy_analysis()
